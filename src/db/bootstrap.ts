...
const TABLE_DDL: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS invoice_settings (id uuid primary key default gen_random_uuid(), company_name text default 'WXY SOLUTIONS', company_tagline text default 'DESIGN | PRINTING | BRANDING | 3D SIGNAGE', address_line_1 text default 'Dar Es Salaam Branch, Cocacola Road', address_line_2 text default 'Sokoine Road, Central Plaza Opp, Naaz Hotel & Fifi''s Cafe', address_city text default 'Arusha, Arusha', address_country text default 'Tanzania, United Republic of', contact_phone text default '+255 764 713 056 | +255 746 589 376', contact_email text, logo_url text default '/wxy-logo.svg', bank_name text default 'NMB CLOCK TOWER', account_number text default '4081 0217 414', account_name text default 'WXY SOLUTION INVESTMENTS', swift_code text default 'NMIBTZTZ', bank_code text default '016408', branch_code text default '408', mpesa_number text, default_notes text default 'Free Consultation at Your Business Premises if located within Arusha', thank_you_message text default 'Thank you for the business', header_color_left text default '#ff0606', header_color_right text default '#cc1f1f', updated_at timestamp default now())`,
];
